defmodule TdLm.Mixfile do
  ...
  defp deps do
    [
      ...
      {:td_cache, git: "https://github.com/Bluetab/td-cache.git", branch: "feature/td-3063", override: true},
      {:td_df_lib, git: "https://github.com/Bluetab/td-df-lib.git", branch: "feature/td-3063"},
      {:quantum, "~> 3.0"},
