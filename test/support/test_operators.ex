defmodule TdLm.TestOperators do
  @moduledoc """
  ...
  defp sorted([%{"source_id" => _} | _] = list) do
    Enum.sort_by(list, &Map.get(&1, "source_id"))
  end
  ...
  defp approximately_equal(%{"source_id" => id1}, %{"source_id" => id2}), do: id1 == id2
